...
<div class="container">
  ...
  <form action="<%= request.getContextPath() %>/delete" method="post" style="text-align: center;" onsubmit="return confirmDelete();">
